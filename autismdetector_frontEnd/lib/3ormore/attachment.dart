...
List<String> questionare =[
  "The child interacts with other easily ",
  "There are no repeated complaints of avoidance in schools",
  "The child does not get disturbed by unfavourable situations.",
  "The child is obedient when instructed with tasks",
  "The child does not indulge with harsh behaviours or gets physically aggressive.",
  "The child manipulates others to get his own way"
];
            ...
            Container(
                ...
                child: Padding(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          Text('Attachment',style: TextStyle(fontSize: 40),),
                          SizedBox(height: 20),
                      ...
                      onPressed: () {
                        ...
                        Timer(Duration(milliseconds: 500), () {
                          Navigator.push(context,
                              MaterialPageRoute(builder: (contex) => adaptive()));
                        });
                      },
