...
import 'package:autismdetector/3ormore/socialbehaviour.dart';
...
List<String> questionare =[
  ...
  "The child express discomfort verbally indirectly without crying",
  "The child is able to indicate needs",
  "The child shares toys on request",
  "The child recognizes family members",
  "The child can retell a favourite story",
  "The child is able to narrate his/her experience both verbal and non verbal",
  "The child is able to comprehend story",
  "The child is capable of cooperative play",
  "The child does not drool when attempting speech",
];
